...
extension RequestListVC: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
      ...
      let cell = self.tableView.dequeueReusableCell(withIdentifier:"ChatListCell", for: indexPath) as! ChatListCell
          ...
          cell.contactName.text = "\(contact.requestToName)"
          cell.contactNumber.text = contact.requestToMobile
          cell.boldLabel.text = contact.requestToName.first!.description
...
extension RequestListVC: UITextFieldDelegate {
