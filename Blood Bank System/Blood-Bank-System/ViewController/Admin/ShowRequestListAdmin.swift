...
class ShowRequestListAdmin: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    func getBloodRequest(){
        ...
        FireStoreManager.shared.getPendingRequestsAdmin(mobile: "Admin") { err, data in
...
extension ShowRequestListAdmin: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
   ...
   func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
           ...
           let data = filteredContacts[indexPath.row]
            let vc = self.storyboard?.instantiateViewController(withIdentifier: "RequestDetailsViewAdmin") as! RequestDetailsViewAdmin
...
extension ShowRequestListAdmin: UITextFieldDelegate {
